...
export function buildTools(): AppTool[] {
  ...
  const tools: AppTool[] = [
    ...
    { code: 'Member-Consumer and Community Programs', name: 'Member-Consumer and Community Programs Module', description: 'Community electrification, outreach, and member-consumer engagement.', iconKey: 'HandHeart', ownerDepartmentId: 'ISD', access: [{ departmentId: 'ISD', level: 'ADMIN' }], taskSubjects: ['Community Programs'] },
